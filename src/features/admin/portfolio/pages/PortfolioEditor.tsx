        ...
        <form onSubmit={(e) => handleSubmit(e, false)} className="space-y-8">
          <div className="grid grid-cols-3 gap-8">
                ...
                <div className="bg-dark-light border border-white/10 rounded-lg overflow-hidden">
                  {previewMode ? (
                    ...
                    <textarea
                      ...
                      onChange={handleChange}
                      className="w-full bg-transparent px-4 py-3 focus:outline-none min-h-[400px]"
            ...
            <div className="space-y-6">
              ...
              {/* Gallery Images */}
              <div>
                <label className="block text-sm font-medium mb-2">Galeri Görselleri</label>
                ...
                <label className="flex items-center justify-center px-4 py-3 bg-primary/10 hover:bg-primary/20 transition-colors rounded-lg cursor-pointer">
                  <input
                    type="file"
                    accept="image/*"
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium mb-2">Canlı URL</label>
                  <div className="relative">
                    <input
                      ...
                      onChange={handleChange}
                      className="w-full bg-dark-light border border-white/10 rounded-lg pl-4 pr-10 py-3 focus:outline-none focus:border-primary"
                      placeholder="https://"
                    />
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    />
                    <Github className="absolute right-3 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400" />
                  </div>
                </div>
              </div>
