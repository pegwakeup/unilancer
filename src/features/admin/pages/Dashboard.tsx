...
const AdminDashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-dark">
      ...
      {/* Sidebar */}
      <aside
        className={`fixed inset-y-0 left-0 w-64 bg-dark-light border-r border-white/10 z-50 transform lg:translate-x-0 transition-transform duration-300 ${
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4 sm:mb-8">
                ...
                {activeTab === 'blog' && (
                  <button
                    ...
                    className="flex items-center justify-center space-x-2 px-4 py-2 bg-primary rounded-xl hover:bg-primary-dark transition-colors shadow-lg shadow-primary/25"
                  >
              ...
              {activeTab === 'blog' && (
                <>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-4 sm:mb-8">
                    <div className="bg-dark-light border border-white/10 rounded-xl p-4 sm:p-6">
                      <div className="flex items-center justify-between">
                        <div>
                          <p className="text-gray-400 text-sm">Toplam Yazı</p>
                          <h3 className="text-xl sm:text-2xl font-bold mt-1">{stats.totalPosts}</h3>
                        </div>
                    ...
                    <div className="bg-dark-light border border-white/10 rounded-xl p-4 sm:p-6">
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <h3 className="text-xl sm:text-2xl font-bold mt-1">{stats.publishedPosts}</h3>
                        </div>
                    ...
                    <div className="bg-dark-light border border-white/10 rounded-xl p-4 sm:p-6">
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <h3 className="text-xl sm:text-2xl font-bold mt-1">{stats.draftPosts}</h3>
                        </div>
                    ...
                    <div className="bg-dark-light border border-white/10 rounded-xl p-4 sm:p-6">
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <h3 className="text-xl sm:text-2xl font-bold mt-1">{stats.categories.size}</h3>
                        </div>
                        <div className="w-10 h-10 sm:w-12 sm:h-12 bg-primary/10 rounded-xl flex items-center justify-center">
                  ...
                  <div className="bg-dark-light border border-white/10 rounded-xl p-4 sm:p-6 mb-4 sm:mb-8">
                    <div className="flex flex-col sm:flex-row gap-4">
                      <div className="flex-1 relative">
                        ...
                        <input
                          ...
                          className="w-full bg-dark border border-white/10 rounded-xl pl-10 pr-4 py-2 sm:py-3 focus:outline-none focus:border-primary"
                        />
                      </div>
                      ...
                      <select
                        ...
                        className="bg-dark border border-white/10 rounded-xl px-4 py-2 sm:py-3 focus:outline-none focus:border-primary"
                      >
