    ...
    <>
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
        <div>
          ...
          <p className="text-gray-400 mt-1">Gelen proje taleplerini yönetin</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-5 gap-4 lg:gap-6 mb-8">
        <div className="bg-dark-light border border-white/10 rounded-xl p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-gray-400 text-sm">Toplam Talep</p>
        ...
        <div className="bg-dark-light border border-white/10 rounded-xl p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-gray-400 text-sm">İptal Edilen</p>
      ...
      <div className="bg-dark-light border border-white/10 rounded-xl p-4 lg:p-6 mb-8">
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          >
            ...
            <option value="software">Yazıl ım</option>
