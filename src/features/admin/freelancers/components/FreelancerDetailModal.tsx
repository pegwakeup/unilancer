    ...
    <AnimatePresence>
      <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
        <motion.div
          ...
          className="bg-dark-light rounded-xl border border-white/10 w-full max-w-5xl max-h-[90vh] overflow-hidden relative"
        >
          {/* Header */}
          ...
          <div className="p-6 overflow-y-auto max-h-[calc(90vh-4rem)] space-y-8">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              {/* Education & Work */}
              <div className="bg-dark p-6 rounded-xl border border-white/10 space-y-4">
                <h3 className="text-lg font-semibold mb-4">Eğitim ve İş</h3>
                <div className="space-y-4">
                  <div className="flex items-center space-x-3 text-gray-300">
                    <div className="w-10 h-10 bg-primary/10 rounded-lg flex items-center justify-center">
                    ...
                    <div className="flex-1">
                      <div className="text-sm text-gray-400">Eğitim Durumu</div>
                  ...
                  <div className="flex items-center space-x-3 text-gray-300">
                    ...
                    <div className="flex-1">
                      <div className="text-sm text-gray-400">Çalışma Durumu</div>
                  ...
                  <div className="flex items-center space-x-3 text-gray-300">
                    ...
                    <div className="flex-1">
                      <div className="text-sm text-gray-400">Başvuru Tarihi</div>
              ...
              {/* Files & Links */}
              <div className="bg-dark p-6 rounded-xl border border-white/10 space-y-4">
                <h3 className="text-lg font-semibold mb-4">Dosyalar ve Linkler</h3>
                <div className="space-y-4">
                  {freelancer.cv_url && (
                    <a
                  ...
                  {freelancer.portfolio_url && (
                    ...
                    >
                      ...
                      <div className="flex-1">
                        <div className="text-sm text-gray-400">Portfolyo</div>
                        <div className="flex items-center space-x-1">
                          <span>Görüntüle</span>
                          <ExternalLink className="w-4 h-4" />
                        </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="bg-dark p-6 rounded-xl border border-white/10">
                <h3 className="text-lg font-semibold mb-4">Ana Uzmanlık Alanları</h3>
              ...
              {/* Sub Expertise */}
              <div className="bg-dark p-6 rounded-xl border border-white/10">
                <h3 className="text-lg font-semibold mb-4">Alt Uzmanlıklar</h3>
                <div className="flex flex-wrap gap-2">
            ...
            {/* Tools & Technologies */}
            <div className="bg-dark p-6 rounded-xl border border-white/10">
              <h3 className="text-lg font-semibold mb-4">Araçlar ve Teknolojiler</h3>
              <div className="flex flex-wrap gap-2">
            ...
            <div className="bg-dark p-6 rounded-xl border border-white/10">
              ...
              <p className="text-gray-300 whitespace-pre-wrap">{freelancer.about_text}</p>
            </div>

            {/* Portfolio Links */}
            {freelancer.portfolio_links.length > 0 && (
              <div className="bg-dark p-6 rounded-xl border border-white/10">
                <h3 className="text-lg font-semibold mb-4">Portfolyo Linkleri</h3>
