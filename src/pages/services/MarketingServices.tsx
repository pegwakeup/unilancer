...
import { 
  Search, Target, LineChart, BarChart2,
  CheckCircle, Zap, ArrowUpRight
} from 'lucide-react';
import { SEOSEMModal } from '../../components/ui/service-modals/marketing/seo-sem-modal';
import { DigitalAdsModal } from '../../components/ui/service-modals/marketing/digital-ads-modal';
import { AnalyticsModal } from '../../components/ui/service-modals/marketing/analytics-modal';
...
const MarketingServices = () => {
  ...
  return (
    <div className="pt-24 pb-16">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          >
            ...
            <p className="text-xl text-gray-300">
              Markanızı dijital dünyada öne çıkaracak etkili pazarlama çözümleri
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <ServiceCard
              ...
              onClick={() => setActiveModal('seo-sem')}
            />

            <ServiceCard
              icon={Target}
              title="Dijital Reklam"
              description="Hedefli ve etkili dijital reklam kampanyaları ile dönüşüm oranlarınızı artırın."
              items={[
              ...
              onClick={() => setActiveModal('digital-ads')}
            />

            <ServiceCard
              icon={BarChart2}
              title="Analitik & Raporlama"
              description="Veri odaklı kararlar ile dijital pazarlama stratejilerinizi optimize edin."
              items={[
                "Web Analitik",
                "Dönüşüm Takibi",
                "A/B Testleri",
          ...
          >
            ...
            <div className="relative max-w-3xl mx-auto text-center">
              <h2 className="text-3xl md:text-4xl font-bold mb-4">
                Dijital Pazarlama Stratejinizi Oluşturalım
              </h2>
      ...
      <SEOSEMModal 
        isOpen={activeModal === 'seo-sem'} 
        onClose={() => setActiveModal(null)} 
      />
      <DigitalAdsModal 
        isOpen={activeModal === 'digital-ads'} 
        onClose={() => setActiveModal(null)} 
      />
      <AnalyticsModal 
