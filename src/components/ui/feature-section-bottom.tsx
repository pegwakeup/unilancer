            ...
            <div className="grid lg:pl-6 grid-cols-1 sm:grid-cols-3 items-start lg:grid-cols-1 gap-4">
              <div className="flex flex-row gap-4 items-start">
                ...
                <div className="flex flex-col gap-1">
                  <p className="text-white text-sm lg:text-base">Esnek Çalışma</p>
              ...
              <div className="flex flex-row gap-4 items-start">
                <Check className="w-4 h-4 mt-1 text-primary" />
                <div className="flex flex-col gap-1">
                  <p className="text-white text-sm lg:text-base">Adil Kazanç</p>
                  <p className="text-gray-400 text-xs lg:text-sm">
              ...
              <div className="flex flex-row gap-4 items-start">
                <Check className="w-4 h-4 mt-1 text-primary" />
                <div className="flex flex-col gap-1">
                  <p className="text-white text-sm lg:text-base">Sürekli Gelişim</p>
                  <p className="text-gray-400 text-xs lg:text-sm">
